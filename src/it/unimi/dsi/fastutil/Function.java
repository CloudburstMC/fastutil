 ...
 * for example, {@link it.unimi.dsi.fastutil.ints.Int2LongFunction} extends {@link IntToLongFunction} and {@link it.unimi.dsi.fastutil.ints.Int2IntFunction} extends
 * {@link IntUnaryOperator}. For functions that do not have a corresponding JDK function we extend the
 * closest possible function (widening input and output types): for example, {@link it.unimi.dsi.fastutil.bytes.Byte2CharFunction} extends
